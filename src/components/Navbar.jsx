                    ...
                    <div className="hidden md:flex items-center space-x-6 relative">
                        {menuItems.map((item, index) => (
                            <Link to={item.path} key={item.path}>
                                <motion.div
                                    className={`relative px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 group ${location.pathname === item.path
                                ...
                                >
                                    ...
                                    <div
                                        className={`absolute inset-0 bg-[#64ffda]/0 group-hover:bg-[#64ffda]/10 transition-all duration-300 rounded-lg ${location.pathname === item.path
                                            ? 'bg-[#64ffda]/20'
                                            : ''
                                            }`}
                                    ></div>
                                    <div
                                        className={`absolute top-1 right-1 w-1.5 h-1.5 bg-[#64ffda] rounded-full animate-pulse transition-opacity ${location.pathname === item.path
                                            ? 'opacity-100'
                    ...
                    >
                        <div className="relative px-4 pt-4 pb-6 space-y-2">
                            ...
                            {menuItems.map((item, index) => (
                                ...
                                >
                                    <motion.div
                                        className={`relative px-4 py-3 text-base font-medium rounded-lg transition-all duration-300 group ${location.pathname === item.path
                                            ? 'text-[#64ffda] border border-[#64ffda] shadow-[0_0_15px_rgba(100,255,218,0.8)]'
